...
} from "./chunk-7Y55SRTM.js";
import {
  Label,
  dist_exports as dist_exports3
} from "./chunk-YG4UYDFM.js";
import {
  Anchor,
  Anchor2,
  Arrow,
...
import {
  ...
  useId,
  useLayoutEffect2
} from "./chunk-JRZWS3T3.js";
import "./chunk-2JSXUALH.js";
import {
  dist_exports,
  useDirection
} from "./chunk-47TBHDN6.js";
import {
  Primitive,
  Root,
  dispatchDiscreteCustomEvent
} from "./chunk-BXXWI55Q.js";
import {
  require_react_dom
...
var AlertDialogPortal = (props) => {
  ...
  const dialogScope = useDialogScope(__scopeAlertDialog);
  return (0, import_jsx_runtime5.jsx)(Portal3, { ...dialogScope, ...portalProps });
};
...
var ContextMenuLabel = React10.forwardRef(
  (props, forwardedRef) => {
    ...
    const menuScope = useMenuScope(__scopeContextMenu);
    return (0, import_jsx_runtime9.jsx)(Label2, { ...menuScope, ...labelProps, ref: forwardedRef });
  }
);
...
var Menubar = React13.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeMenubar,
      value: valueProp,
    ...
    const [currentTabStopId, setCurrentTabStopId] = React13.useState(null);
    return (0, import_jsx_runtime12.jsx)(
      MenubarContextProvider,
      {
        scope: __scopeMenubar,
        value,
        onMenuOpen: React13.useCallback(
          (value2) => {
            setValue(value2);
        ...
        onMenuClose: React13.useCallback(() => setValue(""), [setValue]),
        onMenuToggle: React13.useCallback(
          (value2) => {
...
var MenubarMenu = (props) => {
  ...
  const wasKeyboardTriggerOpenRef = React13.useRef(false);
...
var MenubarTrigger = React13.forwardRef(
  (props, forwardedRef) => {
...
var MenubarContent = React13.forwardRef(
  (props, forwardedRef) => {
...
var MenubarGroup = React13.forwardRef(
  (props, forwardedRef) => {
...
var MenubarLabel = React13.forwardRef(
  (props, forwardedRef) => {
    const { __scopeMenubar, ...labelProps } = props;
    const menuScope = useMenuScope2(__scopeMenubar);
    return (0, import_jsx_runtime12.jsx)(Label2, { ...menuScope, ...labelProps, ref: forwardedRef });
  }
);
MenubarLabel.displayName = LABEL_NAME3;
var ITEM_NAME3 = "MenubarItem";
var MenubarItem = React13.forwardRef(
  (props, forwardedRef) => {
...
var MenubarCheckboxItem = React13.forwardRef(
  (props, forwardedRef) => {
...
var MenubarRadioGroup = React13.forwardRef(
  (props, forwardedRef) => {
...
var MenubarRadioItem = React13.forwardRef(
  (props, forwardedRef) => {
...
var MenubarItemIndicator = React13.forwardRef((props, forwardedRef) => {
...
var MenubarSeparator = React13.forwardRef(
  (props, forwardedRef) => {
...
var MenubarArrow = React13.forwardRef(
  (props, forwardedRef) => {
...
var MenubarSubTrigger = React13.forwardRef(
  (props, forwardedRef) => {
...
var MenubarSubContent = React13.forwardRef(
  (props, forwardedRef) => {
...
var OneTimePasswordField = React15.forwardRef(
  function OneTimePasswordFieldImpl({
    ...
    const sanitizeValue = React15.useCallback(
      (value2) => {
    ...
    const controlledValue = React15.useMemo(() => {
    ...
    const validationTypeRef = React15.useRef(validation);
    React15.useEffect(() => {
      if (!validation) {
        return;
      }
    ...
    const hiddenInputRef = React15.useRef(null);
    const userActionRef = React15.useRef(null);
    ...
    const locateForm = React15.useCallback(() => {
      let formElement;
      if (form) {
    ...
    const attemptSubmit = React15.useCallback(() => {
    ...
    const valueRef = React15.useRef(currentValue);
...
var OneTimePasswordFieldHiddenInput = React15.forwardRef(function OneTimePasswordFieldHiddenInput2({ __scopeOneTimePasswordField, ...props }, forwardedRef) {
...
var OneTimePasswordFieldInput = React15.forwardRef(function OneTimePasswordFieldInput2({
  __scopeOneTimePasswordField,
  onInvalidChange,
  index: indexProp,
  ...props
  ...
  const keyboardActionTimeoutRef = React15.useRef(null);
  React15.useEffect(() => {
    return () => {
...
var PasswordToggleField = ({
  ...
  const [inputIdState, setInputIdState] = React16.useState(defaultInputId);
  const inputId = inputIdState ?? defaultInputId;
  const syncInputId = React16.useCallback(
  ...
  const focusState = React16.useRef(INITIAL_FOCUS_STATE);
...
var PasswordToggleFieldInput = React16.forwardRef(
  ({
    __scopePasswordToggleField,
...
var PasswordToggleFieldToggle = React16.forwardRef(
  ({
    __scopePasswordToggleField,
    onClick,
    onPointerDown,
    ...
    const [internalAriaLabel, setInternalAriaLabel] = React16.useState(void 0);
...
var PasswordToggleFieldIcon = React16.forwardRef(
  ({
    __scopePasswordToggleField,
    // @ts-expect-error
    children,
...
var SelectContentImpl = React21.forwardRef(
  (props, forwardedRef) => {
    ...
    useFocusGuards();
    const focusFirst3 = React21.useCallback(
      (candidates) => {
...
var Separator4 = React24.forwardRef((props, forwardedRef) => {
...
var ToastProvider = (props) => {
  ...
  return (0, import_jsx_runtime26.jsx)(Collection7.Provider, { scope: __scopeToast, children: (0, import_jsx_runtime26.jsx)(
    ...
    return (0, import_jsx_runtime26.jsxs)(
      Branch,
      {
        ...
        children: [
          ...
          (0, import_jsx_runtime26.jsx)(Collection7.Slot, { scope: __scopeToast, children: (0, import_jsx_runtime26.jsx)(Primitive.ol, { tabIndex: -1, ...viewportProps, ref: composedRefs }) }),
          hasToasts && (0, import_jsx_runtime26.jsx)(
            FocusProxy,
            {
...
var ToastImpl = React28.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime26.jsxs)(import_jsx_runtime26.Fragment, { children: [
      ...
      (0, import_jsx_runtime26.jsx)(ToastInteractiveProvider, { scope: __scopeToast, onClose: handleClose, children: ReactDOM3.createPortal(
        (0, import_jsx_runtime26.jsx)(Collection7.ItemSlot, { scope: __scopeToast, children: (0, import_jsx_runtime26.jsx)(
          Root2,
          {
            asChild: true,
...
var ToolbarToggleItem = React31.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime29.jsx)(ToolbarButton, { asChild: true, ...scope, children: (0, import_jsx_runtime29.jsx)(Item24, { ...toggleGroupScope, ...toggleItemProps, ref: forwardedRef }) });
  }
);
...
var TooltipPortal = (props) => {
  ...
  return (0, import_jsx_runtime30.jsx)(PortalProvider3, { scope: __scopeTooltip, forceMount, children: (0, import_jsx_runtime30.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime30.jsx)(Portal, { asChild: true, container, children }) }) });
};
        ...
        children: (0, import_jsx_runtime30.jsxs)(
          Content,
          {
            ...
            children: [
              ...
              (0, import_jsx_runtime30.jsx)(VisuallyHiddenContentContextProvider, { scope: __scopeTooltip, isInside: true, children: (0, import_jsx_runtime30.jsx)(Root5, { id: context.contentId, role: "tooltip", children: ariaLabel || children }) })
            ]
          }
        )
      }
